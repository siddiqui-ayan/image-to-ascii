...
class ImageToAscii:
    def __init__(self,imagePath: str=None,witdh:int=100,outputFile:str=None):
        '''
        ...
        self.ascii_image = "\n".join([self.new_image_data[index:(index+self.witdh)] for index in range(0, self.pixel_count, self.witdh)])
